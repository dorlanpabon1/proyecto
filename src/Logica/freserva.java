...
public class freserva {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "Idhabitacion", "Numero", "Idcliente", "Cliente", "Idtrabajador", "Trabajador", "Tipo reserva", "Fecha reserva", "Fecha ingreso", "Fecha salida", "Costo alojamiento", "Estado"};
        ...
        sSQL = "select r.idreserva,r.idhabitacion,h.numero,r.idcliente,"
                ...
                + "r.idtrabajador,(select nombre from persona where idpersona=r.idtrabajador)as trabajador,"
                ...
                + " from reserva r inner join habitacion h on r.idhabitacion=h.idhabitacion where r.fecha_reserva like '%" + buscar + "%' order by idreserva desc";
        try {
            ...
            while (rs.next()) {
                ...
                registro[6] = rs.getString("trabajador") + " " + rs.getString("trabajadorap");
